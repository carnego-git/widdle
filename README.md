[![CI](https://travis-ci.org/zupzup/widdle.svg?branch=main)](https://travis-ci.org/zupzup/widdle)
[![crates.io](https://meritbadge.herokuapp.com/widdle)](https://crates.io/crates/widdle)
[![docs](https://docs.rs/widdle/badge.svg)](https://docs.rs/widdle)

# widdle

An async, synchronized, database-backed Rust job scheduler

**Note: widdle requires at least Rust 1.39.**
...
# widdle = { version = "0.3", features = ["pool-mobc"] }
```
...
```rust
use widdle::{async_trait, JobConfig, RunnerConfig, Job, JobRunner};
...
Can be found in the [examples](https://github.com/zupzup/widdle/tree/main/examples) folder.
